package ru.pavlov.androidexampleclient;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelEditText = this.findViewById(R.id.editTextModel);
        fuelEditText = this.findViewById(R.id.editTextFuel);
        yearEditText = this.findViewById(R.id.editTextYear);
